...
namespace TP_PROYECTO_SOFTWARE.Application.UseCases.Reservations.Handlers
{
    public class CreateReservationHandler : ICreateReservationHandler
    {
        ...
        private readonly ReservationSettingsOptions _reservationSettings;
        ...
        public CreateReservationHandler(
            ...
            IOptions<ReservationSettingsOptions> reservationSettings,
            IMapper mapper)
        {
        ...
        public async Task<ReservationGetDTO> Handle(CreateReservationCommand command)
        {
            ...
            var reservation = BuildReservation(user.Id, seat.Id, _reservationSettings.ExpirationMinutes);
        ...
        private static Reservation BuildReservation(int userId, Guid seatId, int expirationMinutes)
        {
            ...
            return new Reservation
            {
                ...
                ExpiresAt = reservedAt.AddMinutes(expirationMinutes)
            };
        }
